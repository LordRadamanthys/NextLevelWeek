...
import { View, TouchableOpacity, StyleSheet, Image, Text, ScrollView, Alert } from 'react-native'
...
const Points = () => {
    ...
    const [items, setItems] = useState<ItemIterface[]>([])
    ...
    useEffect(() => {
        async function loadPosition() {
            ...
            if (status !== 'granted') {
                Alert.alert('Ops', 'Preciso da sua permissão para sua localização')
                return
            }
